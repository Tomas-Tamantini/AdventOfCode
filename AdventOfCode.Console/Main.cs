...
Console.WriteLine($"Day 4 - Fertilizer - Lowest location number with individual seeds: {fertilizer.LowestLocationNumber()}");
Console.WriteLine($"Day 4 - Fertilizer - Lowest location number with seeds as ranges: {fertilizer.LowestLocationNumberWithSeedsAsRange()}");
